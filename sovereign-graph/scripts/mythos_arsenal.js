...
async function runZeroGenThreatDetector() {
  return await ZVD.execute('ZERO_GEN_THREAT', 'FALSE_POSITIVE', async () => {
    ...
    const threats = {
      ...
      injection: ['<script src=', '// SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED // SOVEREIGN: BLOCKED eval( //  //  //  //  //  //  //  //  //  //  //  //  //  //  //  //  //  //  //  //  // ', 'document.write(', 'innerHTML', 'onclick=', 'onerror='],
